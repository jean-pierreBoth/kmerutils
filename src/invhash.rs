//! This module provides for inversible hash in 32bit and 64 bits version
//! Thomas Wang's invertible integer hash functions.
...
/// retrives a u32 key from a u32 hash value
